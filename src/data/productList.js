const products = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        "bodyTR": [
          "Sisteme tek araç bağlıyken 200kW gücünde; iki araç bağlıyken 2x100kW gücünde eş zamanlı şarj işlemi sağlayabilmektedir.",
          "2 veya daha fazla şarj çıkışı verilebilir.",
          "Aynı sistem üzerinden hem CC2 hem de pantograf ile yüksek hızlı şarj imkanı sunar. (opsiyonel)",
          "OCPP desteği ile kredi/banka kartı, RFID kart, NFC veya mobil ödeme yöntemleriyle temassız ve kolay bir ödeme deneyimi sunar. (opsiyonel)"
        ]
    ...
    items: [
      {
        ...
        bodyTR: [
          'NetAgent, yeni nesil bir SNMP (Basit Ağ Yönetimi Protokolü) izleme ürünüdür.',
          'UPS\'i uzaktan kontrol etmekle kalmayıp mevcut durumunu da elde etmekle kalmaz,',
          'NetAgent II -3Portlar da, örneğin, diğer işlevleri sağlayabilir.',
