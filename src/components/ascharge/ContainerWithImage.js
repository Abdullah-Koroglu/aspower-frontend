...
const ContainerWithImage = ({locale}) => {
  ...
  return (
    <div
      className="mt-16 bg-[#111B2D] text-white md:px-10 xl:px-20 md:overflow-visible relative md:h-96 flex items-center"
    >
      <div className="flex flex-col md:flex-row justify-between gap-4 md:my-8 max-md:mt-4 max-md:pb-0 p-4 md:overflow-visible">
        <div>
        ...
        <Image
          className={`w-[calc(100vw-2rem)] md:w-60 xl:w-96 h-[26rem] top-[-2rem] object-top rounded-2xl md:absolute right-10 xl:right-64`}
          width={2000}
          height={1000}
          src={data.image}
          alt={'image'}
