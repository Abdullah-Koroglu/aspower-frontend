...
const ImageContainer = ({ locale }) => {
  ...
  return (
    <div style={{ backgroundImage: `url(${data.image})`, backgroundSize: 'cover', backgroundPosition: 'center center' }} className="flex justify-between gap-4 p-4 pt-10 md:max-xl:px-10 xl:pt-24">
      <div className="flex items-end gap-8 justify-between xl:p-16 max-md:pb-96 max-xl:pb-32">
