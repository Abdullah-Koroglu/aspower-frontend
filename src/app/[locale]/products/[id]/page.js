...
async function page({params}) {
  ...
  const data = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/products?filters[slug][$eq]=${id}&locale=${locale}&populate[0]=Banner&populate[1]=BodyImages&populate[2]=Images&populate[3]=DataSheet`)
